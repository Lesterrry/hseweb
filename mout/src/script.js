...
{
    cursor.x.corner = event.clientX
    cursor.y.corner = event.clientY
...
const tick = () =>
{
    ...
    cursor.x.cornerCurrent += (cursor.x.corner - cursor.x.cornerCurrent) * (TPF * 12);
    cursor.y.cornerCurrent += (cursor.y.corner - cursor.y.cornerCurrent) * (TPF * 12);
